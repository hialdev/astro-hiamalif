...
<template>
  <div ref="dropdownRef" class="fixed bottom-0 start-0 z-[1] h-auto m-5">
      <div v-if="isOpen" class="bg-white mb-3 shadow-xl bottom-0 start-0 min-w-[15em] rounded-xl">
        <div class="p-2">
          <ul class="flex flex-col gap-1">
            <li class="p-2 px-4 rounded-lg bg-slate-50">
      ...
      <div @click="isOpen = !isOpen" :class="`inline-flex items-center shadow-xl cursor-pointer justify-center p-3 bg-white rounded-xl hover:text-purple-800 gap-3 relative ${isOpen ? 'text-purple-800' : ''}`">
